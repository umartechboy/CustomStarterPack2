...
import struct
import bpy, bmesh, os, sys, math, argparse, json, warnings
# Suppress Blender-specific deprecation warnings (e.g., Material.use_nodes)
warnings.filterwarnings("ignore", category=DeprecationWarning, module="bpy")
